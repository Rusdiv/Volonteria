    ...
    <div className={styles.vacancies}>
      <div className={styles.vacan}>
        <div className={styles.header}>
          ...
          <div>от 45 000 руб</div>
        </div>
        <h3 className={styles.title}>Сборщик-грузчик</h3>
        <div className={styles.elipses}>
          <div className={styles.elipse}>Без опыта</div>
          <div className={styles.elipse}>Полная занятость</div>
          <div className={styles.elipse}>Сменный график</div>
        </div>
